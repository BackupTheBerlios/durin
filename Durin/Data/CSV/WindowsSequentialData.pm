...
package Durin::Data::CSV::WindowsSequentialData;
...
sub open
  {
    ...
    $extInfo->open($access) or die "Durin::Data::CSV::WindowsSequentialData: Unable to open ExtInfo\n"; 
...
sub getNextRow
  { 
    ...
    return Durin::Utilities::StringUtilities::removeCtrlMEnter($line);
  }
