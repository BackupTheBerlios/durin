...
use Class::MethodMaker
  get_set => [ -java => qw/CountTable BetaMatrix EquivalentSampleSize InternalNQuoteUC InternalNQuoteUVC WuvMatrix StructureStubborn/];
