...
use Class::MethodMaker
  get_set => [ -java => qw/ReductionFactor/];
...
sub setCountTableAndInitialize  {
  ...
  $self->SUPER::setCountTableAndInitialize($ct);
  ...
  $self->setReductionFactor(-$self->CalculateLogWuv($row_to_classify,$class_val,$att1,$att2));
