...
# usage: 
# It is commonly called through RunExperiment.pl
# it can also be called as
# IndComp2.pl <script_file>
...
sub doRun {
  ...
  $LCInput->{APPLIER} = Durin::Classification::Experimentation::AUCModelApplier->new();
  $input->{LC} = $LCInput;
